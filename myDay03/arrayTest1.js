...
// slice(begin, end) : 원하는 부분을 추출하기 위해 시작 인덱스(inclusice)와 마지막 인덱스(exclusive)를 전달한다.
...
// 월~일까지 Array 객체에 담은 후 출력
// forEach는 Array 객체에서만 사용 가능!
var dayss = "월화수목금토일".split("");
var days = ["월","화","수","목","금","토","일"];
days.forEach(function(v){console.log(v)});
dayss.forEach(function(v){console.log(v)});
