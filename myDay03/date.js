...
// 객체 선언
var now = new Date();
console.log(now.toUTCString())// UTC시간대를 문자열로 출력한다.(Thu, 15 Sep 2022 06:41:59 GMT)
console.log(now.toLocaleString())// (2022. 9. 15. 오후 3:41:59)
console.log(now.toLocaleTimeString())// (오후 3:41:59)
